...
const PostCard = ({ post }) => (
  <div className="hover:bg-gray-300 bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
      <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8 ">
        ...
        />
        <p className="inline align-middle text-gray-500 ml-2 font-medium text-lg">
          {post.author.name}
        </p>
      </div>
